...
;
const metadata = {
    title: "YouTube SuperChat Tracker",
    description: "Track YouTube superchats and donations for live streamers with real-time progress visualization, contributor leaderboards, and goal tracking.",
    keywords: [
        "youtube",
        "superchat",
        "donations",
